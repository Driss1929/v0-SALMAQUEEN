    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-gray-600">
          Share your thoughts and experiences for each day of the challenge
        </p>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
        <h2 className="text-xl font-bold text-gray-800 mb-4 text-center">
          Day {selectedDay} - Write Your Entry
        </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
         ...
         <div className="bg-white rounded-2xl shadow-lg p-6">
           <div className="text-center mb-4">
             <div className="w-16 h-16 rounded-full mx-auto mb-3 overflow-hidden border-2 border-pink-200">
               <img
                 ...
                 onError={(e) => {
                   ...
                   if (e.target.src.includes('.jpg')) {
                     e.target.src = '/idriss-profile.svg'
                   } else {
               ...
               />
               <div className="w-full h-full bg-pink-100 flex items-center justify-center text-2xl text-pink-600" style={{ display: 'none' }}>
                 🌸
               </div>
             </div>
          ...
          {getEntry(selectedDay, 'idriss') ? (
            <div className="space-y-3">
              <div className="text-xs text-gray-500 text-center">
                {getEntry(selectedDay, 'idriss').timestamp}
              </div>
         ...
         <div className="bg-white rounded-2xl shadow-lg p-6">
             ...
             <div className="w-16 h-16 rounded-full mx-auto mb-3 overflow-hidden border-2 border-blue-200">
               <img
                 ...
                 onError={(e) => {
                   // Try SVG fallback first
                   if (e.target.src.includes('.jpg')) {
                     e.target.src = '/salma-profile.svg'
                   } else {
                     // Fallback to colored initial if both images fail
                     e.target.style.display = 'none'
                     e.target.nextSibling.style.display = 'flex'
               ...
               />
               <div className="w-full h-full bg-blue-100 flex items-center justify-center text-2xl text-blue-600" style={{ display: 'none' }}>
                 💙
               </div>
             </div>
          ...
          {getEntry(selectedDay, 'salma') ? (
            <div className="space-y-3">
              <div className="text-xs text-gray-500 text-center">
                {getEntry(selectedDay, 'salma').timestamp}
              </div>
